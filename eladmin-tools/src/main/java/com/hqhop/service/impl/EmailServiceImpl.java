...
import com.hqhop.domain.EmailConfig;
import com.hqhop.domain.vo.EmailVo;
import com.hqhop.exception.BadRequestException;
import com.hqhop.repository.EmailRepository;
import com.hqhop.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    public void send(EmailVo emailVo, EmailConfig emailConfig){
        ...
        account.setFrom(emailConfig.getNick()+"<"+emailConfig.getFromUser()+">");
        //ssl方式发送
