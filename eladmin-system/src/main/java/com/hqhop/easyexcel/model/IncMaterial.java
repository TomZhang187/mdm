...
public class IncMaterial  extends BaseRowModel {
    ...
    @ExcelProperty(value = "新物料编码", index = 4)
    ...
    @ExcelProperty(value = "默认工厂", index = 20)
    private String defaultFactory;


    @ExcelProperty(value = "自定义项（物料类型）", index = 21)
    private String custom;

    @ExcelProperty(value="自定义项（采购员）", index = 22)
    private String buyer;

    @ExcelProperty(value="自定义项（货位）", index = 23)
    private String zhy;

    @ExcelProperty(value = "是否封存", index = 24)
    private String enable;

    @ExcelProperty(value = "封存时间", index = 25)
    ...
    @ExcelProperty(value = "委外类型", index = 31)
    private String outsourcingType;

    @ExcelProperty(value = "物料型态", index = 32)
    private String materialKenel;



    @ExcelProperty(value = "是否需求合并", index = 33)
    private String isDemandConsolidation;

    @ExcelProperty(value = "是否虚项", index = 34)
    private String isImaginaryTerm;



    @ExcelProperty(value = "是否成本对象", index = 35)
    private String isCostObject;


    @ExcelProperty(value = "是否发料", index = 36)
    private String isHairFeed;


    @ExcelProperty(value = "是否根据检验结果入库", index = 37)
    private String isInspectionWarehousing;


    @ExcelProperty(value = "是否免检", index = 38)
    private String isInspect;

    @ExcelProperty(value = "是否按生产订单核算成本", index = 39)
    private String isOrderCost;

    @ExcelProperty(value = "是否按成本中心统计产量", index = 40)
    ...
    @ExcelProperty(value = "是否出入库", index = 44)
    private String isOutgoingWarehousing;

    @ExcelProperty(value = "是否批次核算", index = 45)
    private String  isBatchesAccount;


    @ExcelProperty(value = "计价方式", index = 46)
    private String  valuationMethod;


    @ExcelProperty(value = "安全库存", index = 47)
    private String  safetyStock;

    @ExcelProperty(value = "最低库存", index = 48)
    private String  minStock;

    @ExcelProperty(value = "最高库存", index = 49)
    private String  maxStock;

    @ExcelProperty(value = "再订购点", index = 50)
    private String againBuyPlace;

//    @ExcelProperty(value = "生产部门", index = 51)
//    private String againBuyPlace;
//
//    private String

    @ExcelProperty(value = "计划属性", index = 53)
    private String  planningAttribute;

    @ExcelProperty(value = "固定提前期", index = 54)
